...
},{"./src/index":3,"./src/modes/Byte":4}],2:[function(require,module,exports){
	...
	function QRcode(options) {
		...
		return (function () {
			var _typeNumber = _options.typeNumber,
				_minTypeNumber = _options.minTypeNumber >> 0,
			...
			var make = function () {
				...
				if (_typeNumber < 1) {
					var typeNumber = _minTypeNumber >= 1 ? _minTypeNumber : 1;
...
},{"../encode/utf-8":2}],5:[function(require,module,exports){
var QRMode = {
	MODE_NUMBER: 1 << 0,
	MODE_ALPHA_NUM: 1 << 1,
	MODE_8BIT_BYTE: 1 << 2,
